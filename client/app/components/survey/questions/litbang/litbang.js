...
.config(($stateProvider, $urlRouterProvider) => {
  ...
  $stateProvider
    ...
    .state('litbang.question14', {
      url: '/question-14',
      parent: 'litbang',
      no:14,
      component: 'questionDynamic'
    })
    .state('litbang.question15', {
      url: '/question-15',
      parent: 'litbang',
      no:15,
      component: 'questionDynamic'
    })
    .state('litbang.question16', {
      url: '/question-16',
      parent: 'litbang',
      no:16,
      component: 'questionDynamic',
    })
    .state('litbang.question17', {
      url: '/question-17',
      parent: 'litbang',
      no:17,
      component: 'questionDynamic',
    })
    .state('litbang.question18', {
      url: '/question-18',
      parent: 'litbang',
      no: 18,
      component: 'questionDynamic',
    })
    .state('litbang.question19', {
      url: '/question-19',
      parent: 'litbang',
      no: 19,
      component: 'questionDynamic'
